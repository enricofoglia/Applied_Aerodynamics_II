...
# Object function
def obj_fun(name, hypP, constraints, Cl_minD = 0.9, Cl_maxD = 1.4, Cl_cruise = 1.2):
    ...
    data = [End_max-100, Cl_max, Delta_alpha, End_Cl_133, End_integral-50] # remember to change
    #-------------------------------------------------------------------------
